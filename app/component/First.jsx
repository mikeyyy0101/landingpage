...
const First = () => {
  return (
    <section className="text-white py-18 md:px-45 px-2">
      <motion.div 
          className="max-w-screen-xl mx-auto px-6 lg:px-20 text-left"
          initial={{y:100, opacity:0}}
          animate={{y:0, opacity:1}}
          transition={{duration:0.8, ease:'linear'}}    
      >
        <motion.h1 
            className="text-5xl md:text-5xl font-semibold leading-tight max-w-4xl"
        ...
        <motion.p 
            className="font-semibold text-white/60 mt-6 text-xl max-w-2xl"
            initial={{x:20, opacity:0}}
            animate={{x:0, opacity:1}}
        ...
        >
          <button className="bg-white text-black px-6 py-3 rounded-lg font-medium hover:bg-white/90 transition">
            Start building
          </button>
          <button className="ml-5 relative group rounded-lg p-2 overflow-hidden">
